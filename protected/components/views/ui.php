			...
			<div class="row-fluid sortable">
				...
				<div class="box span7">
					...
					<div class="box-content">
						...
						<?php for($i=1;$i<=8;$i++){ ?>
								<li><img src="<?php echo Yii::app()->baseUrl?>/img/ajax-loaders/ajax-loader-<?php echo $i ?>.gif" title="<?php echo Yii::app()->baseUrl?>/img/ajax-loaders/ajax-loader-<?php echo $i ?>.gif" ></li>
						<?php } ?>
						</ul>
