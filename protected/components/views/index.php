			...
			<div class="row-fluid">
				<div class="box span12">
					...
					<div class="box-content">
						<h1>Yiirisma <small>free, premium quality, responsive, multiple skin YII admin template.</small></h1>
						<p>Its a live demo of the template. I have created Yiirisma to ease the repeat work I have to do on my projects. Now I re-use Charisma as a base for my admin panel work and I am sharing it with you :)</p>
					...
					<div class="box-content">
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active" id="info">
								<h3>Yiirisma <small>a fully featued template</small></h3>
								<p>Its a fully featured, responsive template for your admin panel. Its optimized for tablet and mobile phones. Scan the QR code below to view it in your mobile device.</p> <img alt="QR Code" class="charisma_qr center" src="<?php echo Yii::app()->baseUrl?>/img/qrcode136.png" />
							</div>
